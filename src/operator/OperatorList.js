...
const OperatorList = () => {
    ...
    const onClickEdit = (slug) => {
        navigate('/update-operator/' + slug)
    }
    const onClickDelete = (slug) => {
        setIsDeleted(false)
        callAPI('delete', 'operators/' + slug);

    }
    const onclickPermission =()=>{
        navigate("/operators-permission")
    }
                            ...
                            <div className="card">
                                ...
                                <div className="table-responsive">
                                    <table className="table card-table table-vcenter text-nowrap datatable">
                                        ...
                                        <tbody>
                                            {responce.length > 0 && responce.map((data, i) => (
                                                <tr key={i + 1}>
                                                    <td >{i + 1}</td>
