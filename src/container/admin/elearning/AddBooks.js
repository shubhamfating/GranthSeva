...
function AddBooks() {
    ...
    const onClickSubmit = () => {
        callAPI("post", apiRoutes.admin.ebook.add, data);
    };
                                            ...
                                            <div className="row">
                                                ...
                                                <div className='col-md-6 mt-3'>
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control" type="url" placeholder={content.book_link} onChange={(e) => setData({ ...data, book_link: e.target.value })} />
