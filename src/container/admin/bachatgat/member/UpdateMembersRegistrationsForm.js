...
const UpdateMembersRegistrationsForm = () => {
    ...
    useEffect(() => {
        callAPI("get", "members/" + slug);
    }, []);


    const onClickSubmit = () => {
        callAPI("put", `members/${slug}`, data);
    ...
    return (
        <AdminAppBody
            loading={loading}
            heading= {content.member_info_heading} 
            content={
...
export default UpdateMembersRegistrationsForm