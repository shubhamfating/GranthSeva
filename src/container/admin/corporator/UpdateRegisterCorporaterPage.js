...
const UpdateRegisterCorporaterPage = () => {
    ...
    const submitCorporatorData = () => {
      callAPI("put", `corporator/${slug}`, formData);
    ...
    if (responce && responce.first_name && !isSet) {
        setFormData({ ...responce });
        isSetData(true)

    }
    if (responce && responce.status === 'updated') {

        navigate(uiRoutes.admin.corporator.show)
    }
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <input className="form-control" type="url" placeholder={content.party_website} 
                            value={formData.party_website}
                          onChange={(e) => setFormData({ ...formData, party_website: e.target.value })} />
...
export default UpdateRegisterCorporaterPage